...
<a href="./temp.png" download="tokyo_temp.png" class="btn btn-outline-primary">PNG画像をダウンロード</a>
...
<a href="./temp_lineplot.png" download="tokyo_temp_line.png" class="btn btn-outline-primary">PNG画像をダウンロード</a>
